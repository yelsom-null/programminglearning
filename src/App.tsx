...
const App: React.FC = () => {
  ...
  const getLessonComponent = (lessonId: string): React.ReactNode => {
    ...
    switch (lessonId) {
      ...
      case 'console':
        return <MuiTextProvider><ConsoleLesson darkMode={darkMode} /></MuiTextProvider>;
        
      case 'string-concatenation':
        return <MuiTextProvider><StringConcatenationLesson darkMode={darkMode} /></MuiTextProvider>;
        
      case 'numbers-in-js':
        return <MuiTextProvider><NumbersLesson darkMode={darkMode} /></MuiTextProvider>;
        
      case 'increment-decrement':
        return <MuiTextProvider><IncrementDecrementLesson darkMode={darkMode} /></MuiTextProvider>;
        
      case 'undefined-undeclared':
        return <MuiTextProvider><UndefinedLesson darkMode={darkMode} /></MuiTextProvider>;
